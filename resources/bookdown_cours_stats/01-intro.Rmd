...
Ces deux phrases sont justes, et il n'y a pas lieu d'en choisir une plus que l'autre.
...
# fonction qui tire un échantillon d'une certaione taille dans une liste
...
On parle d'agrégation lorsqu'on désirer regrouper des données disponibles à un niveau de découpage donné au niveau de découpage supérieur (plus large, par exemple , regroupper les données de communes à l'échelle des départements.)

Cela revient à inférer des caractéristiques concernant les unités agrégées d’après les caractéristiques individuelles.
