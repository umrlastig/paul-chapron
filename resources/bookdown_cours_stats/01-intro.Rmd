...
«les chiffres c'est pas une science exacte figurez-vous.» rappelait utilement Karadoc ( Kaamelott, Livre V, Le dernier recours) 
...
disponibles à un niveau de découpage donné et résumer ces données en quelques valeurs. 
...
Le problème de cette réduction de dimensionnalité (résumer N observation par une seule valeur, c'est passer de N à 1 ) est qu'elle va inévitablement appauvrir l'information. 
Même quand cette concession est faite, les outils habituels ne sont pas toujours adaptés. Par exemple, la moyenne algébrique n'est pas indiquée en cas de distribution très asymétrique. Vous trouverez des exemples qui montrent les limites de la moyenne dans la section \@ref(forme) du chapitre \@ref(univariee)
...
-   La plupart des phénomènes d'intérêts sont multi-scalaires,
    ...
    niveaux d'échelle (et que leurs formes changent...).
...
-   Des effets de la géométrie du découpage (appelés effets de zonage)
    modifient la représentation cartographique des données
