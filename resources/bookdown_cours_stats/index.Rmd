--- 
title: "Analyse Statistique M2 IGAST, et DESIGEO"
author: 'PC '
date: "`r Sys.Date()`"
documentclass: book
bibliography:
...
Dans cette introduction, on parle beaucoup d'analyse spatiale, parce que c'est dans ce contexte que les rudiments de statistiques exposés ici vont être utilisés mais aucune technique purement spatiale n'est abordée ici. 
