...
> Formellement, pour une population donnée,  la distribution d'une variable $V$ peut être définie comme une fonction qui donne la probabilité qu'un individu $x$ pris au hasard dans la population ait une certaine valeur pour la variable $V$, , qu'on note  $V_x$  : 
$$distribution(V) \equiv P(V=V_x), \forall V_x \in \Omega_V$$
> avec $\Omega_V$ l'ensemble des valeurs que peut prendre $V$, qu'on appelle l'univers de $V$. 
...
### Interpréter la courbe de densité  {#interpretdens}
